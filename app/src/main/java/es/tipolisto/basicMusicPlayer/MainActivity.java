...
import es.tipolisto.basicMusicPlayer.textospeech.MiOninitListener;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Vemos los permisos antes de continuar
        ...
        //El gran amigo para escichar múscia
        ...
        //Nuestra clase que contiene el ContentResolver de android para devolvernos la música que tenga .mp3 o .wav
        handlerMusic =new HandlerMusic(this);
        arrayListFiles=new ArrayList<File>();
        arrayListTitles=new ArrayList<String>();

        //la list view será global de la clase main
        updateListView();
    ...
    private void updateListView(){
        ...
        if(permisoDeLectura) {
            ...
            arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, arrayListTitles);
        }
        else {
            arrayListTitles.add("No tienes permisos de lectura");
            arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, arrayListTitles);
        }
    ...
    void checkPermissionReadStorage(){
